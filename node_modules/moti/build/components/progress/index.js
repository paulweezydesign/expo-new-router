...
export function MotiProgressBar({ height = 12, progress = 0, borderRadius = height / 2, style, colorMode = 'dark', containerColor = colorMode === 'dark' ? '#333' : '#eee', containerStyle, color = '#00C806', transition = {
    ...
    return useMemo(() => (_jsx(View, Object.assign({ style: outerStyle }, { children: _jsx(MotiView, { transition: _transition, state: barState, style: progressStyle }, void 0) }), void 0)), [_transition, barState, outerStyle, progressStyle]);
}
