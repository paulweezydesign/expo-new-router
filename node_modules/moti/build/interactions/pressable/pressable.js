...
export const MotiPressable = forwardRef(function MotiPressable(props, ref) {
    ...
    const child = (_jsx(MotiView, Object.assign({ from: from, exit: exit, transition: transition, exitTransition: exitTransition, state: state, 
        ...
        //   return animate
        // }, [])}
        style: style, onLayout: onLayout }, { children: typeof children == 'function' ? children(interaction) : children }), void 0));
    let node;
    // if (Platform.OS === 'web' || Platform.OS === 'android') {
    node = (_jsx(Hoverable, Object.assign({ onHoverIn: updateInteraction('hovered', true, onHoverIn), onHoverOut: updateInteraction('hovered', false, onHoverOut), childRef: ref }, { children: _jsx(Pressable, Object.assign({ onLongPress: onLongPress, hitSlop: hitSlop, disabled: disabled, style: containerStyle, onPress: onPress, onPressIn: updateInteraction('pressed', true, onPressIn), onPressOut: updateInteraction('pressed', false, onPressOut), ref: ref, onLayout: onContainerLayout, 
            // Accessibility props
            ...
            onKeyDown: onKeyDown, onKeyUp: onKeyUp, onFocus: onFocus, onBlur: onBlur, href: href }, { children: child }), void 0) }), void 0));
    // }
    // else  {
    //   node = (
...
To silence this warning without solving the actual issue, you can use the dangerouslySilenceDuplicateIdsWarning prop. But you should probably refactor your code instead.`);
    ...
    return (_jsx(MotiPressableContext.Provider, Object.assign({ value: useMemo(() => {
            const interactions = {
                containers: {
                    ...context?.containers,
            ...
            return interactions;
        }, [context?.containers, id, interaction]) }, { children: node }), void 0));
});
