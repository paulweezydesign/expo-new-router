...
export default function Skeleton(props) {
    ...
    return (_jsxs(View, Object.assign({ style: {
            ...
            minWidth: width ?? (children ? undefined : DEFAULT_SIZE),
        } }, { children: [children, _jsx(AnimatePresence, { children: show && (_jsx(MotiView, Object.assign({ style: {
                        position: 'absolute',
                        top: 0,
                        left: 0,
                        borderRadius,
                    ...
                    , { colors: colors, backgroundSize: backgroundSize, measuredWidth: measuredWidth, transition: transition }, `${JSON.stringify(colors)}-${measuredWidth}-${JSON.stringify(transition || null)}`) }), void 0)) }, void 0)] }), void 0));
}
const AnimatedGradient = React.memo(function AnimatedGradient({ measuredWidth, colors, backgroundSize, transition = {}, }) {
    return (_jsx(MotiView, Object.assign({ style: StyleSheet.absoluteFillObject, from: { opacity: 0 }, transition: {
            type: 'timing',
            duration: 200,
            ...
            : undefined }, { children: _jsx(MotiView, Object.assign({ style: [
                ...
                ...transition,
                    ...
                    x: 1,
                    y: 1,
                }, style: StyleSheet.absoluteFillObject }, void 0) }), void 0) }), void 0));
...
function SkeletonGroup({ children, show, }) {
    return (_jsx(SkeletonGroupContext.Provider, Object.assign({ value: show }, { children: children }), void 0));
}
